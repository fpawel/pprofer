...
func NewGraph(prof *Profile, o *GraphOptions) *Graph {
	if o.CallTree {
...
func getStackFrames(locs []*Location) (stack []StackFrame) {
	stack = make([]StackFrame, 0, len(locs))
...
// nodes.
func newGraph(prof *Profile, o *GraphOptions) (*Graph, map[uint64]Nodes) {
	...
	for _, sample := range prof.Sample {
		...
		if parent != nil && !residual {
			...
			parent.Stack = getStackFrames(sample.Location)
		}
	}
...
func newTree(prof *Profile, o *GraphOptions) (g *Graph) {
...
func CreateNodes(prof *Profile, o *GraphOptions) (Nodes, map[uint64]Nodes) {
...
func (nm NodeMap) findOrInsertLine(l *Location, li Line, o *GraphOptions) *Node {
	var objfile string
...
func nodeInfo(l *Location, line Line, objfile string, o *GraphOptions) *NodeInfo {
	if line.Function == nil {
